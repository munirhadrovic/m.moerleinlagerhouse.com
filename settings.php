<?php
	$adresa=" 115 Joe Nuxhall Way Cincinnati, OH 45202"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5134212337;// Broj koji se poziva na dugme CALL US
